...
export interface MarshallGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
  ...
  encodeFunctionData(
    functionFragment: "renounceVetoer",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "setVetoer", data: BytesLike): Result;
...
export interface MarshallGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): MarshallGovernor;
  waitForDeployment(): Promise<this>;

  interface: MarshallGovernorInterface;
  ...
  acceptVetoer: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getVotes: TypedContractMethod<
    [account: AddressLike, tokenId: BigNumberish, timepoint: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  renounceVetoer: TypedContractMethod<[], [void], "nonpayable">;
  ...
  setVetoer: TypedContractMethod<[_vetoer: AddressLike], [void], "nonpayable">;
  ...
  veto: TypedContractMethod<[_proposalId: BigNumberish], [void], "nonpayable">;
  ...
  >;
  getFunction(
    nameOrSignature: "renounceVetoer"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "setProposalNumerator"
  ): TypedContractMethod<[numerator: BigNumberish], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "setVetoer"
  ): TypedContractMethod<[_vetoer: AddressLike], [void], "nonpayable">;
  getFunction(
  ...
  filters: {
    ...
    "VoteCast(address,uint256,uint256,uint8,uint256,string)": TypedContractEvent<
      VoteCastEvent.InputTuple,
      VoteCastEvent.OutputTuple,
      VoteCastEvent.OutputObject
    >;
    ...
    "VoteCastWithParams(address,uint256,uint256,uint8,uint256,string,bytes)": TypedContractEvent<
      VoteCastWithParamsEvent.InputTuple,
      VoteCastWithParamsEvent.OutputTuple,
      VoteCastWithParamsEvent.OutputObject
    >;
