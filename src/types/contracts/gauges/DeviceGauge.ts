...
export interface DeviceGaugeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "claimReward"
...
export namespace DepositDeviceEvent {
  export type InputTuple = [
    from: AddressLike,
    to: AddressLike,
    amount: BigNumberish,
...
export namespace WithdrawDeviceEvent {
  export type InputTuple = [
    from: AddressLike,
    amount: BigNumberish,
    tokenId: BigNumberish
  ];
  export type OutputTuple = [from: string, amount: bigint, tokenId: bigint];
  export interface OutputObject {
    from: string;
    amount: bigint;
    tokenId: bigint;
...
export interface DeviceGauge extends BaseContract {
  connect(runner?: ContractRunner | null): DeviceGauge;
  waitForDeployment(): Promise<this>;

  interface: DeviceGaugeInterface;
  ...
  tokenStaker: TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  ...
  getEvent(
    ...
    DepositDeviceEvent.InputTuple,
    DepositDeviceEvent.OutputTuple,
    DepositDeviceEvent.OutputObject
  >;
  getEvent(
    key: "NotifyReward"
  ): TypedContractEvent<
  ...
  getEvent(
    ...
    WithdrawDeviceEvent.InputTuple,
    WithdrawDeviceEvent.OutputTuple,
    WithdrawDeviceEvent.OutputObject
  >;
  ...
  filters: {
    ...
    "DepositDevice(address,address,uint256,uint256)": TypedContractEvent<
      DepositDeviceEvent.InputTuple,
      DepositDeviceEvent.OutputTuple,
      DepositDeviceEvent.OutputObject
    >;
    DepositDevice: TypedContractEvent<
      DepositDeviceEvent.InputTuple,
      DepositDeviceEvent.OutputTuple,
      DepositDeviceEvent.OutputObject
    >;
    ...
    "WithdrawDevice(address,uint256,uint256)": TypedContractEvent<
      WithdrawDeviceEvent.InputTuple,
      WithdrawDeviceEvent.OutputTuple,
      WithdrawDeviceEvent.OutputObject
    >;
    WithdrawDevice: TypedContractEvent<
      WithdrawDeviceEvent.InputTuple,
      WithdrawDeviceEvent.OutputTuple,
      WithdrawDeviceEvent.OutputObject
    >;
