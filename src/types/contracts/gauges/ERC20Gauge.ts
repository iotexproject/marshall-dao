...
export interface ERC20GaugeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "claimReward"
...
export interface ERC20Gauge extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20Gauge;
  waitForDeployment(): Promise<this>;

  interface: ERC20GaugeInterface;
