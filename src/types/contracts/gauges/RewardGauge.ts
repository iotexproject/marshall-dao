...
export interface RewardGaugeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "claimReward"
...
export interface RewardGauge extends BaseContract {
  connect(runner?: ContractRunner | null): RewardGauge;
  waitForDeployment(): Promise<this>;

  interface: RewardGaugeInterface;
