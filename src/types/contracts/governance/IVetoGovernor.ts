...
export interface IVetoGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "COUNTING_MODE"
...
export interface IVetoGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): IVetoGovernor;
  waitForDeployment(): Promise<this>;

  interface: IVetoGovernorInterface;
