...
export interface VetoGovernorCountingSimpleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface VetoGovernorCountingSimple extends BaseContract {
  connect(runner?: ContractRunner | null): VetoGovernorCountingSimple;
  waitForDeployment(): Promise<this>;

  interface: VetoGovernorCountingSimpleInterface;
