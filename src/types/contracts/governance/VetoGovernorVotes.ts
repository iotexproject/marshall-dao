...
export interface VetoGovernorVotesInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface VetoGovernorVotes extends BaseContract {
  connect(runner?: ContractRunner | null): VetoGovernorVotes;
  waitForDeployment(): Promise<this>;

  interface: VetoGovernorVotesInterface;
