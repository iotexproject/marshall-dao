...
export interface VetoGovernorVotesQuorumFractionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface VetoGovernorVotesQuorumFraction extends BaseContract {
  connect(runner?: ContractRunner | null): VetoGovernorVotesQuorumFraction;
  waitForDeployment(): Promise<this>;

  interface: VetoGovernorVotesQuorumFractionInterface;
