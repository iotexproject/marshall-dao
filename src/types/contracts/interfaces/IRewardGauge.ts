...
export interface IRewardGaugeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "claimReward"
...
export interface IRewardGauge extends BaseContract {
  connect(runner?: ContractRunner | null): IRewardGauge;
  waitForDeployment(): Promise<this>;

  interface: IRewardGaugeInterface;
