...
export interface IVoterInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "epochGovernor",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setEpochGovernor",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "withdrawManaged",
    values: [BigNumberish]
  ): string;
...
export interface IVoter extends BaseContract {
  ...
  depositManaged: TypedContractMethod<
    [_tokenId: BigNumberish, _mTokenId: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  epochGovernor: TypedContractMethod<[], [string], "view">;
  ...
  gaugeToFees: TypedContractMethod<[gauge: AddressLike], [string], "view">;
  ...
  setEpochGovernor: TypedContractMethod<
    [_epochGovernor: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  v1Factory: TypedContractMethod<[], [string], "view">;
  ...
  withdrawManaged: TypedContractMethod<
    [_tokenId: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "depositManaged"
  ): TypedContractMethod<
    [_tokenId: BigNumberish, _mTokenId: BigNumberish],
    [void],
    "nonpayable"
  ...
  >;
  getFunction(
    nameOrSignature: "setEpochGovernor"
  ): TypedContractMethod<[_epochGovernor: AddressLike], [void], "nonpayable">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "withdrawManaged"
  ): TypedContractMethod<[_tokenId: BigNumberish], [void], "nonpayable">;
  ...
  filters: {
    ...
    "GaugeCreated(address,address,address,address,address,address,address,address)": TypedContractEvent<
      GaugeCreatedEvent.InputTuple,
      GaugeCreatedEvent.OutputTuple,
      GaugeCreatedEvent.OutputObject
    >;
