...
export interface BribeVotingRewardInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DURATION"
      | "_deposit"
...
export interface BribeVotingReward extends BaseContract {
  connect(runner?: ContractRunner | null): BribeVotingReward;
  waitForDeployment(): Promise<this>;

  interface: BribeVotingRewardInterface;
  ...
  authorized: TypedContractMethod<[], [string], "view">;
