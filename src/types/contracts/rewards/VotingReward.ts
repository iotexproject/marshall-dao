...
export interface VotingRewardInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DURATION"
      | "_deposit"
...
export interface VotingReward extends BaseContract {
  connect(runner?: ContractRunner | null): VotingReward;
  waitForDeployment(): Promise<this>;

  interface: VotingRewardInterface;
